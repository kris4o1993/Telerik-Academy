namespace DatabaseConnections
{
    ...
    public class WorkingWithMySql
    {
        ...
        private static void AddBooks()
        {
            ...
            MySqlCommand mySqlCommand = new MySqlCommand(@"INSERT INTO Books (Title, Author, PublishDate, ISBN) VALUES (@title, @author, @publishDate, @isbn)", mySqlConnection);
        ...
        private static void FindBooksByName(string substring)
        {
            ...
            MySqlCommand mySqlCommand = new MySqlCommand(@"SELECT Title, Author, PublishDate, ISBN FROM Books WHERE LOCATE(@substring, Title)", mySqlConnection);
        ...
        private static void ListingAllBooks()
        {
            ...
            MySqlCommand mySqlCommand = new MySqlCommand(@"SELECT Title, Author, PublishDate, ISBN FROM Books", mySqlConnection);
        ...
        private static void DeleteAllRecords()
        {
            ...
            MySqlCommand mySqlCommand = new MySqlCommand(@"DELETE FROM Books WHERE BookId > 0", mySqlConnection);
