namespace DatabaseConnections
{
    ...
    public class WorkingWithSQLite
    {
        ...
        private static void AddBooks()
        {
            ...
            SQLiteCommand mySqlCommand = new SQLiteCommand(@"INSERT INTO Books (Title, Author, PublishDate, ISBN) VALUES (@title, @author, @publishDate, @isbn)", mySqlConnection);
        ...
        private static void ListingAllBooks()
        {
            ...
            SQLiteCommand mySqlCommand = new SQLiteCommand(@"SELECT Title, Author, PublishDate, ISBN FROM Books", mySqlConnection);
        ...
        private static void DeleteAllRecords()
        {
            ...
            SQLiteCommand mySqlCommand = new SQLiteCommand(@"DELETE FROM Books WHERE BookId > 0", mySqlConnection);
